...
//
        //start fungsi D
$d1 = sqrt((($y1 - $y1a) * ($y1 - $y1a)) + (($y2 - $y2a) * ($y2 - $y2a)) + (($y3 - $y3a) * ($y3 - $y3a)) + (($y4 - $y4a) * ($y4 - $y4a)));
$d2 = sqrt((($y1 - $y1b) * ($y1 - $y1b)) + (($y2 - $y2b) * ($y2 - $y2b)) + (($y3 - $y3b) * ($y3 - $y3b)) + (($y4 - $y4b) * ($y4 - $y4b)));
$d3 = sqrt((($y1 - $y1c) * ($y1 - $y1c)) + (($y2 - $y2c) * ($y2 - $y2c)) + (($y3 - $y3c) * ($y3 - $y3c)) + (($y4 - $y4c) * ($y4 - $y4c)));

$d1m = sqrt((($y1m - $y1a) * ($y1m - $y1a)) + (($y2m - $y2a) * ($y2m - $y2a)) + (($y3m - $y3a) * ($y3m - $y3a)) + (($y4m - $y4a) * ($y4m - $y4a)));
$d2m = sqrt((($y1m - $y1b) * ($y1m - $y1b)) + (($y2m - $y2b) * ($y2m - $y2b)) + (($y3m - $y3b) * ($y3m - $y3b)) + (($y4m - $y4b) * ($y4m - $y4b)));
$d3m = sqrt((($y1m - $y1c) * ($y1m - $y1c)) + (($y2m - $y2c) * ($y2m - $y2c)) + (($y3m - $y3c) * ($y3m - $y3c)) + (($y4m - $y4c) * ($y4m - $y4c)));
//end   fungsi D
//
        //start fungsi hasil
$v1 = $d1m / ($d1 + $d1m);
