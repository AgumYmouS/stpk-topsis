  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <div class="x_content">
        <a style="float: right" href="form_kriteria.php"><button type="button" class="btn btn-primary" style="font-size:18px;">Tambah</button></a>
        <br>
        <br>
        <br>
...
// Check connection
        ...
        $result = $conn->query($sql);
            ...
            echo "<table border='1' class='Tabeldata' style='border: solid 2px black;'><tr><th>Id</th><th>Nama Kriteria</th><th>Action</th></tr>";
    // output data of each row
            while($row = $result->fetch_assoc()) {
                echo '<tr><td>'.$row["id"].'</td><td>'.$row["nama_kriteria"].'</td><td><a onclick="return confirm(\'Hapus ?\')" style="color:red" href="kriteria.php?hapus='.$row["id"].'"><button class="btn btn-danger" type="button"><b>Hapus</b></button></a></td></tr>';
            }
            echo "</table>";
        }
        if (!empty($_GET['hapus'])) {
        mysqli_query($conn, "delete from kriteria where id=$_GET[hapus]");
